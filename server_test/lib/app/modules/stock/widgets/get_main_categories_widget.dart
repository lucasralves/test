...
class GetMainCategoriesWidget extends StatefulWidget {

  final String path;
  final Function action;

  const GetMainCategoriesWidget({Key key, this.path, this.action}) : super(key: key);

  @override
  _GetMainCategoriesWidgetState createState() => _GetMainCategoriesWidgetState();
}

class _GetMainCategoriesWidgetState extends State<GetMainCategoriesWidget> {
